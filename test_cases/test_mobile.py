...
class Test_Mobile:
    ...
    @allure.description('this test verifies a mortgage repayment')
    ...
    @allure.description('this test verifies saved transactions details')
    def test_saved_details(self):
        MobileFlows.mortgage_flow('5000', '8', '3', Save.Yes)
        MobileFlows.swipe_screen(Direction.LEFT)
        MobileFlows.verify_rate_delete_transactions('3.0')
